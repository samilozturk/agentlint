...
import { buildArtifactPathHintsMarkdown } from "./artifact-path-hints";
...
export function buildArtifactSpecMarkdown(type: ArtifactType): string {
  ...
  const lines: string[] = [
    ...
    "2. Analyze candidate content with analyze_artifact or analyze_context_bundle.",
    "3. Revise content in client LLM/editor.",
    "4. Re-run quality_gate_artifact until target score is met.",
    "5. Run validate_export before final delivery.",
    "",
    "## Path hints",
    "",
