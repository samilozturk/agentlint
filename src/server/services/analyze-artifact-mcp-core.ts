...
import type { JudgeDimensionScores, MetricExplanation } from "@/lib/judge";
...
export type AnalyzeArtifactMcpCoreOutput = {
  ...
  result: {
    ...
    analysis: ReturnType<typeof buildJudgeAnalysis>;
  };
};
...
function buildDeterministicWarnings(analysis: ReturnType<typeof buildJudgeAnalysis>): string[] {
...
export async function analyzeArtifactMcpCore(
  ...
  const firstPassAnalysis = buildJudgeAnalysis({
    type: input.type,
