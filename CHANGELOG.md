...
- Prepared the next package versions: `@agent-lint/cli@0.4.3` and `@agent-lint/mcp@0.3.3`.
...
- Hardened GitLab npm publishing so release jobs support both plain and file-based `NPM_TOKEN` variables.
