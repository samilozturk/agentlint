...
- [Boris Cherny: How the Claude Code team uses CLAUDE.md](https://x.com/AravindVijayara/status/1936825964765745419) - workflow discipline patterns from the Claude Code creator: plan-first default, subagent strategy, self-improvement loops, verification gates, and autonomous problem solving.
